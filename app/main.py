...
LECTURE_STEPS = [
    {
        ...
        "duration": "4 min",
        "mode": "compare",
        "question": "How are Frodo and Sauron connected through the One Ring?",
        "center": "Frodo",
        "hops": 2,
        "topK": 8,
        "demoAction": "Aplicar abre a comparacao. A mesma pergunta separa evidencia textual, caminho estrutural e sintese hibrida.",
        "talkingPoints": [
            "RAG, Graph e GraphRAG recuperam evidencias de natureza diferente.",
            "A pergunta sobre Frodo, Sauron e o One Ring existe no texto e no grafo.",
            "A resposta so faz sentido depois de auditar o contexto recuperado.",
        ],
        "methodContrasts": [
            {"label": "RAG", "text": "Recupera trechos sobre o Ring, Mordor, Frodo e a missao."},
            {"label": "Graph", "text": "Mostra caminhos e relacoes entre Frodo, Sauron e entidades proximas."},
            {"label": "GraphRAG", "text": "Combina a estrutura Frodo-Sauron com trechos que explicam o papel do Ring."},
        ],
        "architecture": {
            "name": "Mapa do fluxo",
            ...
            "risk": "Comparar respostas sem mostrar contexto recuperado vira avaliacao enganosa.",
        },
        "speakerNotes": [
        ...
        "quiz": {
            "question": "Se o grafo mostra Frodo conectado a Sauron, o que ainda falta para explicar a relacao?",
            "options": [
                {"label": "Nada: uma aresta ja explica tudo.", "correct": False, "explanation": "Errado. A aresta mostra conexao, nao explica o papel narrativo do Ring."},
                {"label": "Evidencia textual sobre o Ring, a missao e Mordor.", "correct": True, "explanation": "Correto. A estrutura localiza a relacao; o texto explica por que ela importa."},
            ...
            "answer": "A resposta correta e a segunda: o grafo localiza a relacao, mas a explicacao vem dos trechos sobre o One Ring e a missao.",
        },
    },
    {
        "id": "rag-good",
        ...
        "duration": "5 min",
        "mode": "rag",
        "question": "How does Boromir justify using the Ring?",
        "center": "Boromir",
        "topK": 8,
    ...
    },
    {
        ...
        "duration": "5 min",
        "mode": "rag",
        "question": "Who connects Rohan, Gondor, and the war against Mordor?",
        "center": "Theoden",
        "topK": 8,
        ...
        "talkingPoints": [
            ...
            "O erro seria deixar o LLM preencher a lacuna com conhecimento externo.",
        ],
        "methodContrasts": [
        ...
        "speakerNotes": [
            "Se o RAG recuperar coisa ruim, isso revela a fronteira do metodo.",
    ...
    },
    {
        ...
        "duration": "6 min",
        "mode": "graph",
        "question": "Which characters connect Rohan and Gondor in the graph?",
        "center": "Theoden",
        "hops": 2,
        ...
        "quiz": {
            ...
            "options": [
                ...
                {"label": "Quando queremos que o LLM invente uma teoria politica.", "correct": False, "explanation": "A resposta deve ficar ancorada em evidencias."},
            ],
    ...
    },
    {
        ...
        "duration": "5 min",
        "mode": "hybrid",
        "question": "Why does Aragorn's march to the Black Gate help Frodo's mission?",
        "center": "Aragorn",
        "hops": 2,
        "topK": 8,
    ...
    },
    {
        ...
        "duration": "7 min",
        "mode": "compare",
        "question": "How can we audit whether Saruman is an antagonist by speech, alliance, or graph position?",
        "center": "Saruman",
        "hops": 2,
        "topK": 6,
        ...
        "speakerNotes": [
            "O sistema cobre Graph-only, KG-as-Index e Hybrid; Text-to-Query aparece nos exemplos Cypher.",
    ...
    },
    {
        ...
        "duration": "5 min",
        "mode": "graph",
        "question": "What changes in Gandalf's neighborhood when I move from 1-hop to 3-hop?",
        "center": "Gandalf",
        "hops": 1,
        ...
        "architecture": {
            ...
            "takeaway": "A aplicacao usa intuicao de GNN para recuperar contexto, nao para aprender embeddings de nos.",
        ...
        "quiz": {
            ...
            "options": [
                ...
                {"label": "Cada hop treina uma nova rede neural.", "correct": False, "explanation": "Nao ha treino de GNN nesse pipeline."},
    ...
    },
    {
        ...
        "duration": "5 min",
        "mode": "compare",
        "question": "Does Gandalf's influence come from structural centrality, narrative authority, or both?",
        "center": "Gandalf",
        "hops": 2,
        "topK": 8,
        "demoAction": "Aplicar abre Compare. Antes de rodar, estime qual coluna deve vencer.",
        "talkingPoints": [
